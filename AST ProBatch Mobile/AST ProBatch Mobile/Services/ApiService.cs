...
namespace AST_ProBatch_Mobile.Services
{
    public class ApiService
    {
        ...
        public async Task<Response> LogExecutionGetTemplates(string accessToken)
        {
            return await HttpGet(accessToken, this.ApiControllerSet, ApiMethod.LogExecutionGetTemplates);
        }

        public async Task<Response> LogExecutionGetResults(string accessToken, LogExecutionResultQueryValues QueryValues)
        {
        ...
        public async Task<Response> CommandDataGetExecution(string accessToken, CommandDataExecutionQueryValues QueryValues)
        {
            return await HttpPost(accessToken, this.ApiControllerSet, ApiMethod.CommandDataGetExecution, QueryValues);
        }

        public async Task<Response> CommandDataGetObservation(string accessToken, CommandDataObservationQueryValues QueryValues)
        {
        ...
        public async Task<Response> CommandDataGetExecutionHistory(string accessToken, CommandDataExecutionHistoryQueryValues QueryValues)
        {
            return await HttpPost(accessToken, this.ApiControllerSet, ApiMethod.CommandDataGetExecutionHistory, QueryValues);
        }
        #endregion
