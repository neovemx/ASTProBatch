...
namespace AST_ProBatch_Mobile.Views
{
    ...
    public partial class ProcessMonitorTwoPage : ContentPage
    {
        public ProcessMonitorTwoPage()
        {
            InitializeComponent();
        }
        ...
        {
            var imageButton = (ImageButton)sender;
            var instanceItem = imageButton.CommandParameter as ProcessMonitorTwoViewModel;
        ...
        private void InstanceItemsListView_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            {
                MainViewModel.GetInstance().ProcessMonitorThree = new ProcessMonitorThreeViewModel(instanceitem);
                ProcessMonitorThreePage processMonitorThreePage = new ProcessMonitorThreePage();
                processMonitorThreePage.Title = instanceitem.Title;
                Application.Current.MainPage.Navigation.PushAsync(processMonitorThreePage);
